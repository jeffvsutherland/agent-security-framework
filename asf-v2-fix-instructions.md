...
### 🚨 openai-image-gen
- **Issue:** Reads OPENAI_API_KEY from environment (line 176)
- **Severity:** CRITICAL
- **Fix Type:** wrapper_script
...
### 🚨 nano-banana-pro
- **Issue:** Reads GEMINI_API_KEY from environment (line 29)
- **Severity:** CRITICAL
- **Fix Type:** wrapper_script
