...
def main():
    ...
    parser.add_argument('account', nargs='?', help='Account to check (ff, scrum, or all)')
    parser.add_argument('--count', '-c', type=int, default=5, help='Number of recent emails to show')
