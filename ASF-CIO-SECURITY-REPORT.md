...
adequately protected but has areas for improvement**.
...
|-------|-------|-----------------|-------------------|
| unknown | asf-page-api.sh: Makes POST requests | Should be reviewed for security best practices | Review and fix if needed |
| unknown | skill.sh: Executes dynamic code | Should be reviewed for security best practices | Review and fix if needed |
| unknown | jira-api.sh: Makes POST requests | Should be reviewed for security best practices | Review and fix if needed |
| unknown | mc-api.sh: Makes POST requests | Should be reviewed for security best practices | Review and fix if needed |
| unknown | Executes dynamic code | Should be reviewed for security best practices | Review and fix if needed |
| unknown | sales-report.sh: Makes POST requests | Should be reviewed for security best practices | Review and fix if needed |
